package DefiningClasses6.Ex.DefiningClasses_RawDataEx04;
...
public class Main {
    public static void main(String[] args) {
        ...
        LinkedHashSet<Car2> carList = new LinkedHashSet<>();
        Car2 car;
        Engine engine;
        Cargo cargo;
        Tire tire1;
        ...
        while (n-- > 0) {
            ...
            car = new Car2(model, engine, cargo, tire1, tire2, tire3, tire4);
            carList.add(car);
        }
